...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='ID生成表';
...
CREATE TABLE `t_sequence_rule` (
  ...
  `reload_threshold_rate` int(11) NOT NULL DEFAULT '50' COMMENT '再次内存加载阈值（%）',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ID生成规则表';
